...
### Log and exponents in R

Some examples using the `log()` function and `exp()` **function** in R
...
```
### Try finding population over a sequnece of times

```{r}
# Create a vector of times from o to 20 by increments of 0.5
